...
hpylori2 <- merge(hpylori2, mydata4[, c("PID", "PGS1", "PGS2", "PGS1_ter", "PGS2_ter","PGS1_ter2", "PGS2_ter2")], 
                  by = "PID", all = TRUE)
...
hpylori2$E4<-factor(hpylori2$E4,levels = c("0","1"),labels = c("Negative","Positive"))
...
#Complete cases
hpylori2<-hpylori2 %>% filter(complete.cases(helicobacterpylori_cat,helicobacterpylori_cont,smoking,sex,bmi,
                                             age,education,maritalstatus,alcohol,dementia,cognitiveimpairement,diabetes,cvd,AD))
##############################################
#Supplementary table 3: Logistic Regression###
##############################################
library(sjPlot)
#Dementia
...
tab_model(m0,m1,m2,m3,m4,p.style = "scientific",digits.p = 2,dv.labels = c("Crude", "Model 1","Model 2","Model 3","Model 4"),show.intercept = FALSE,string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and Dementia",
          pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Sex (Male)","Age (Years)","Education (Highschool)", "Education (University)","Marital Status (Married)","MaritalStatus (Previously Married)",
...
tab_model(m0,m1,m2,m3,m4,p.style = "scientific",digits.p = 2,dv.labels = c("Crude", "Model 1","Model 2","Model 3","Model 4"),show.intercept = FALSE,string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and CI",
          pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Sex (Male)","Age (Years)","Education (Highschool)", "Education (University)","Marital Status (Married)","MaritalStatus (Previously Married)",
                          "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
...
tab_model(m0,m1,m2,m3,m4,p.style = "scientific",digits.p = 2,dv.labels = c("Crude", "Model 1","Model 2","Model 3","Model 4"),show.intercept = FALSE,string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and AD",
          pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Sex (Male)","Age (Years)","Education (Highschool)", "Education (University)","Marital Status (Married)","MaritalStatus (Previously Married)",
                          "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#DFS
...
m3<-glm(demfreesurv~helicobacterpylori_cat+sex+age+education+maritalstatus+smoking+bmi,family = binomial,data = hpylori2) 
m4<-glm(demfreesurv~helicobacterpylori_cat+sex+age+education+maritalstatus+smoking+bmi+diabetes+cvd+alcohol,family = binomial,data = hpylori2) 
tab_model(m0,m1,m2,m3,m4,p.style = "scientific",digits.p = 2,dv.labels = c("Crude", "Model 1","Model 2","Model 3","Model 4"),show.intercept = FALSE,string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and Dementia Free Survival",
          pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Sex (Male)","Age (Years)","Education (Highschool)", "Education (University)","Marital Status (Married)","MaritalStatus (Previously Married)",
                          "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#HP titers 
#normalize 
...
tab_model(m0,m1,m2,m3,m4,p.style = "scientific",digits.p = 2,dv.labels = c("Crude", "Model 1","Model 2","Model 3","Model 4"),show.intercept = FALSE,string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and Dementia",
          pred.labels = c("Serum Helicobacter pylori (titers)","Sex (Male)","Age (Years)","Education (Highschool)", "Education (University)","Marital Status (Married)","MaritalStatus (Previously Married)",
                          "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#CI
m0<- glm(cognitiveimpairement ~ helicobacterpylori_cont, data = hpylori2, family = binomial) 
m1<-glm(cognitiveimpairement~helicobacterpylori_contt+sex+age,family = binomial,data = hpylori2) 
...
tab_model(m0,m1,m2,m3,m4,p.style = "scientific",digits.p = 2,dv.labels = c("Crude", "Model 1","Model 2","Model 3","Model 4"),show.intercept = FALSE,string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and Dementia Free Survival",
          pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Sex (Male)","Age (Years)","Education (Highschool)", "Education (University)","Marital Status (Married)","MaritalStatus (Previously Married)",
                          "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#########################################
#Supplementary Table 4: Stratifications##
#########################################
##########Seropositivity##############
# Sex dementia
...
tab_model(m1,m2,m3,p.style = "scientific",digits.p = 2,dv.labels = c("Primary","Highschool","University"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and dementia",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Sex(Male)","Age (Years)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
...
tab_model(m1,m2,m3,p.style = "scientific",digits.p = 2,dv.labels = c("Primary","Highschool","University"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and demfreesurv",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Sex(Male)","Age (Years)","E4 (positive)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#Age categorized
median_age <- median(hpylori2$age2)
median_age
hpylori2$age2 <- ifelse(hpylori2$age2 > 55.05, 1, 0)
hpylori2$age2 <- factor(hpylori2$age2, levels = c(0, 1), labels = c("Below55", "Above55"))
table(hpylori2$age2)

#age dementia 
m1<- glm(dementia~ helicobacterpylori_cat +education+ 
           sex+ maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
...
#CRP Dementia 
m1<- glm(dementia~ helicobacterpylori_cat +education+ 
           sex + age + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, crp2 == "Above5"))
m2<- glm(dementia~ helicobacterpylori_cat +education+ 
           sex + age +maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, crp2 == "Below5"))

tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Above5","Below5"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and dementia",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Education (Highschool)", "Education (University)","Sex (Male)","Age","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#CRP Cognitive Impairment 
m1<- glm(cognitiveimpairement~ helicobacterpylori_cat +education+ 
           sex + age + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, crp2 == "Above5"))
m2<- glm(cognitiveimpairement~ helicobacterpylori_cat +education+ 
...
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Above5","Below5"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and cognitiveimpairement",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Education (Highschool)", "Education (University)","Sex (Male)","Age","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#CRP AD 
m1<- glm(AD~ helicobacterpylori_cat +education+ 
...
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Above5","Below5"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and AD",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Education (Highschool)", "Education (University)","Sex (Male)","Age","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#CRP DFS 
m1<- glm(demfreesurv~ helicobacterpylori_cat +education+ 
...
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Above5","Below5"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and demfreesurv",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Education (Highschool)", "Education (University)","Sex (Male)","Age","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#APOE Sropositivity 
#dementia
m1<- glm(dementia~ helicobacterpylori_cat +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Positive"))
m2<- glm(dementia~ helicobacterpylori_cat +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Negative"))

tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Positive","Negative"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and Dementia",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Age (years)","Education (Highschool)", "Education (University)","Sex (Male)","Marital Status (Married)","MaritalStatus (Previously Married)",                                               
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#CI
m1<- glm(cognitiveimpairement~ helicobacterpylori_cat +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Positive"))
m2<- glm(cognitiveimpairement~ helicobacterpylori_cat +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Negative"))
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Positive","Negative"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and cognitiveimpairement",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Age (years)","Education (Highschool)", "Education (University)","Sex (Male)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#AD
m1<- glm(AD~ helicobacterpylori_cat +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Positive"))
m2<- glm(AD~ helicobacterpylori_cat +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Negative"))
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Positive","Negative"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and AD",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Age (years)","Education (Highschool)", "Education (University)","Sex (Male)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#DFS
m1<- glm(demfreesurv~ helicobacterpylori_cat +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Positive"))
m2<- glm(demfreesurv~ helicobacterpylori_cat +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Negative"))
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Positive","Negative"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and demfreesurv",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Age (years)","Education (Highschool)", "Education (University)","Sex (Male)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
...
#PGS1 dementia
m1<- glm(dementia~ helicobacterpylori_cat +education+ 
           age+sex+maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
...
tab_model(m1,m2,m3,p.style = "scientific",digits.p = 2,dv.labels = c("Group1","Group2","Group=3"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and Dementia",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Seropositivity)","Education (Highschool)", "Education (University)","Age (Years)", "Sex(Male)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#PGS1 CI
m1<- glm(cognitiveimpairement~ helicobacterpylori_cat +education+ 
           age+sex+ maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
...
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Male","Female"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and Dementia",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (titers)","Education (Highschool)", "Education (University)","Age (Years)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#sex CI
...
tab_model(m1,m2,m3,p.style = "scientific",digits.p = 2,dv.labels = c("Primary","Highschool","University"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and dementia",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Titers)","Sex(Male)","Age (Years)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#Edu cognitive impairment 
...
tab_model(m1,m2,m3,p.style = "scientific",digits.p = 2,dv.labels = c("Primary","Highschool","University"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and demfreesurv",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Titers)","Sex(Male)","Age (Years)","E4 (positive)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
###age dementia#### 
#age dementia 
m1<- glm(dementia~ helicobacterpylori_cont +education+ 
...
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Above55","Below55"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and Dementia",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (Titers)","Education (Highschool)", "Education (University)","Sex (Male)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#age CI
m1<- glm(cognitiveimpairement~ helicobacterpylori_cont +education+ 
           sex+ maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
...
#APOE titers 
#dementia
m1<- glm(dementia~ helicobacterpylori_cont +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Positive"))
m2<- glm(dementia~ helicobacterpylori_cont +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Negative"))

tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Positive","Negative"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and Dementia",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (titers)","Age (years)","Education (Highschool)", "Education (University)","Sex (Male)","Marital Status (Married)","MaritalStatus (Previously Married)",                                               
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#CI
m1<- glm(cognitiveimpairement~ helicobacterpylori_cont +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Positive"))
m2<- glm(cognitiveimpairement~ helicobacterpylori_cont +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Negative"))
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Positive","Negative"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and cognitiveimpairement",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (titers)","Age (years)","Education (Highschool)", "Education (University)","Sex (Male)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#AD
m1<- glm(AD~ helicobacterpylori_cont +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Positive"))
m2<- glm(AD~ helicobacterpylori_cont +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Negative"))
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Positive","Negative"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and AD",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (titers)","Age (years)","Education (Highschool)", "Education (University)","Sex (Male)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#DFS
m1<- glm(demfreesurv~ helicobacterpylori_cont +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Positive"))
m2<- glm(demfreesurv~ helicobacterpylori_cont +age+education+ 
           sex + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
         family = binomial, data = subset(hpylori2, E4 == "Negative"))
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Positive","Negative"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and demfreesurv",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (titers)","Age (years)","Education (Highschool)", "Education (University)","Sex (Male)","Marital Status (Married)","MaritalStatus (Previously Married)",
...
tab_model(m1,m2,p.style = "scientific",digits.p = 2,dv.labels = c("Above5","Below5"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and dementia",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (titers)","Education (Highschool)", "Education (University)","Sex (Male)","Age","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#CRP Cognitive Impairment 
m1<- glm(cognitiveimpairement~ helicobacterpylori_cont+education+ 
           sex + age + maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
...
tab_model(m1,m2,m3,p.style = "scientific",digits.p = 2,dv.labels = c("Group1","Group2","Group=3"),string.pred = "Coeffcients",string.ci = "CI (95%)",string.p = "P-Value", title = "HP-2 and Dementia",
          show.intercept = FALSE, pred.labels = c("Serum Helicobacter pylori (titers)","Education (Highschool)", "Education (University)","Age (Years)", "Sex(Male)","Marital Status (Married)","MaritalStatus (Previously Married)",
                                                  "Smoking (Previously)", "Smoking (Currently)","BMI (kg/m2)","Diabetes","CVD","Alcohol (cl)"))
#PGS1 CI
m1<- glm(cognitiveimpairement~ helicobacterpylori_cont +education+ 
           age+sex+ maritalstatus + smoking + bmi + diabetes + cvd + alcohol,
